...
const ReadBook = () => {
    return (
        ...
        <div>
            ...
            <button className=" px-10 py-4 rounded-xl border border-[#23BE0A] bg-[#23BE0A] text-white text-2xl font-semibold">Sort By </button>
            </div>
...
<div className="  flex flex-col md:flex-row justify-center items-center  gap-10 shadow-lg md:p-5 border rounded-2xl mt-10">
      ...
      <div className="max-w-3xl">
        ...
        <div className="card-actions fontSans justify-start mt-10 gap-5">
          <button className="btn px-6 py-2 rounded-3xl border bg-[#328EFF26] text-[#328EFF] text-xl font-semibold"> Read </button>
          <button className="btn px-6 py-2 rounded-3xl border bg-[#FFAC3326] text-[#FFAC33] text-xl font-semibold">Wishlist</button>
          <button className=" btn px-6 py-2 rounded-3xl border border-[#23BE0A] bg-[#23BE0A] text-white text-xl font-semibold"> View Details </button>
        </div>
      </div>
    </div>
        </div>
