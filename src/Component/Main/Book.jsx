      ...
      <section className="mt-5">
        <div className="card p-4 border shadow-lg">
          ...
          <div className="card-body">
            ...
            <p className="text-xl text-[#131313CC] font-semibold">
              By : {publisher}{" "}
            </p>
            <div className="card-actions justify-between">
              <div className="text-xl text-[#131313CC] font-semibold">
                {category}
              </div>
              <div className="flex gap-2 items-center text-xl text-[#131313CC] font-semibold">
                <span>{rating}</span>
                <span>
                  <CiStar />
                </span>
