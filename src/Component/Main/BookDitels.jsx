  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 items-center  gap-10 shadow-xl md:p-10 border rounded-lg mt-10">
      <div className=" w-full mx-auto rounded-xl bg-[#1313130D]">
        <img
          className=" w-full shadow-lg rounded-xl bg-[#1313130D]"
          src={image}
          alt="Album"
        />
      </div>
      <div className="">
        <h2 className=" text-2xl md:text-5xl font-extrabold fontPlay link link-hover">
          {bookName}
        </h2>
        ...
        <div className="fontSans mt-5 max-w-2xl">
          <div className="mt-3 grid grid-cols-2 ">
            <div className="text-[#131313B3] text-xl font-semibold">
              Number of Pages:
            </div>
        ...
        <div className=" card-actions fontSans justify-start mt-10 gap-5">
          ...
          <button
            ...
            className="btn text-white font-semibold text-xl bg-[#50B1C9]"
          >
            Wishlist
          </button>
        </div>
